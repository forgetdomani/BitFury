...
public class GuerrillaMail {
	 ...
	 * 
	 * @param lang
	 *            the language code. GuerrillaMail contains final Strings for this.
	 */
	...
	/**
	 * The function is used to initialize a session and set the client with an email
	 * address. If the account is expired you will get another address.
	 * 
	 * @throws Exception
	 */
	...
	private void _delEmail(ArrayList<Integer> emailIds) throws ClientProtocolException, IOException {
		...
		// System.out.s("RESPONSE: "+stringResponse);
	}
