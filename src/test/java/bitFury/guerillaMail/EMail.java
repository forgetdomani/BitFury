...
/**
 * Representation of an email. This contains the message, the forwarder and the
 * remaining information in an email.
 * 
...
public class EMail {
	 ...
	 * 
	 * @param jSonObject
	 *            the JSONObject from which to create the EMail object.
